...
/***/ function(module, exports) {
	...
	var sortHighOrder = function sortHighOrder(comparator) {
	  ...
	  return function (list, item) {
	    ...
	    return [].concat(_toConsumableArray(list.slice(0, i)), [item], _toConsumableArray(list.slice(i, list.length)));
	  };
	};

	var sorted = students.reduce(sortHighOrder(function (a, b) {
